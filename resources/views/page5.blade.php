...
<div class="w3-top">
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    ...
    <div class="w3-right w3-hide-small">
      <a href="#about" class="w3-bar-item w3-button">Trang Chu</a>
      <a href="#team" class="w3-bar-item w3-button"><i class="fa fa-user"></i> Gioi Thieu</a>
    ...
    <div class="w3-dropdown-content w3-card-4 w3-bar-block">
      ...
      <a href="#pricing" class="w3-bar-item w3-button"><i class="fa fa-usd"></i> Lien He</a>
    </div>
